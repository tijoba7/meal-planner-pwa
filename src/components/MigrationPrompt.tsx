      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 space-y-5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            {isDone ? (
              <CheckCircle className="text-green-600 shrink-0" size={22} strokeWidth={1.75} />
            ) : isError ? (
              <AlertCircle className="text-red-500 shrink-0" size={22} strokeWidth={1.75} />
            ) : (
              <CloudUpload className="text-green-600 shrink-0" size={22} strokeWidth={1.75} />
            )}
