...
describe('calculateNutrition', () => {
  ...
  it('returns null when no ingredients match the database', () => {
    const ingredients: Ingredient[] = [{ name: 'unobtainium powder', amount: 100, unit: 'g' }]
  ...
  it('divides totals by number of servings', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'chicken breast', amount: 200, unit: 'g' }]
  ...
  it('converts oz to grams correctly', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'chicken breast', amount: 1, unit: 'oz' }]
    const result = calculateNutrition(ingredients, 1)
    expect(result).not.toBeNull()
  ...
  it('converts cups to grams using density for flour', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'all-purpose flour', amount: 1, unit: 'cup' }]
    const result = calculateNutrition(ingredients, 1)
    expect(result).not.toBeNull()
  ...
  it('converts tbsp to grams for olive oil', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'olive oil', amount: 1, unit: 'tbsp' }]
    const result = calculateNutrition(ingredients, 1)
    expect(result).not.toBeNull()
  ...
  it('uses typicalWeightG for count units (eggs)', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'eggs', amount: 2, unit: '' }]
    const result = calculateNutrition(ingredients, 1)
    expect(result).not.toBeNull()
  ...
  it('uses typicalWeightG for "clove" unit (garlic)', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'garlic', amount: 3, unit: 'clove' }]
    const result = calculateNutrition(ingredients, 1)
    expect(result).not.toBeNull()
  ...
  it('handles lb unit correctly', () => {
    ...
    const ingredients: Ingredient[] = [{ name: 'chicken breast', amount: 1, unit: 'lb' }]
    const result = calculateNutrition(ingredients, 1)
    expect(result).not.toBeNull()
...
describe('nutritionResultToRecord', () => {
  it('converts result to the Recipe.nutrition record format', () => {
    const result = calculateNutrition([{ name: 'chicken breast', amount: 100, unit: 'g' }], 1)!
