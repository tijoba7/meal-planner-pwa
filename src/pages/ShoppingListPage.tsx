...
export default function ShoppingListPage() {
  ...
  const { data: lists = [], isLoading: loading, refetch: refetchLists } = useShoppingLists()
  ...
  if (activeList) {
    return (
      <>
        ...
        <BottomSheet
          open={showHouseholdShare}
          onClose={() => setShowHouseholdShare(false)}
        ...
        <BottomSheet open={showExport} onClose={() => setShowExport(false)} title="Share or Export">
  ...
  // --- List view ---
  return (
    <PullToRefresh onRefresh={refetchLists}>
    <div className="p-4 max-w-2xl mx-auto">
      ...
      <BottomSheet open={showCreate} onClose={() => setShowCreate(false)} title="New Shopping List">
