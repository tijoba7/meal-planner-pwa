...
INSERT INTO public.reactions (user_id, recipe_id, type) VALUES
  ...
  ('a0000002-0000-0000-0000-000000000002', 'b0000001-0000-0000-0000-000000000001', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000001-0000-0000-0000-000000000001', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000001-0000-0000-0000-000000000001', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000001-0000-0000-0000-000000000001', 'bookmark'),
  -- Brisket Tacos: liked by everyone else
  ('a0000001-0000-0000-0000-000000000001', 'b0000002-0000-0000-0000-000000000002', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000002-0000-0000-0000-000000000002', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000002-0000-0000-0000-000000000002', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000002-0000-0000-0000-000000000002', 'like'),
  ('a0000001-0000-0000-0000-000000000001', 'b0000002-0000-0000-0000-000000000002', 'bookmark'),
  -- Shakshuka: liked by Alice, Bob
  ('a0000001-0000-0000-0000-000000000001', 'b0000003-0000-0000-0000-000000000003', 'like'),
  ('a0000002-0000-0000-0000-000000000002', 'b0000003-0000-0000-0000-000000000003', 'like'),
  -- Kimchi Jjigae: liked by Alice, Carlos, Emma; bookmarked by Alice
  ('a0000001-0000-0000-0000-000000000001', 'b0000004-0000-0000-0000-000000000004', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000004-0000-0000-0000-000000000004', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000004-0000-0000-0000-000000000004', 'like'),
  ('a0000001-0000-0000-0000-000000000001', 'b0000004-0000-0000-0000-000000000004', 'bookmark'),
  -- Mushroom Risotto: liked by Bob, Carlos, Diana
  ('a0000002-0000-0000-0000-000000000002', 'b0000005-0000-0000-0000-000000000005', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000005-0000-0000-0000-000000000005', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000005-0000-0000-0000-000000000005', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000005-0000-0000-0000-000000000005', 'bookmark'),
  -- Dumplings: liked by Bob, Carlos, Emma
  ('a0000002-0000-0000-0000-000000000002', 'b0000006-0000-0000-0000-000000000006', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000006-0000-0000-0000-000000000006', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000006-0000-0000-0000-000000000006', 'like'),
  -- Guacamole: liked by everyone
  ('a0000001-0000-0000-0000-000000000001', 'b0000007-0000-0000-0000-000000000007', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000007-0000-0000-0000-000000000007', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000007-0000-0000-0000-000000000007', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000007-0000-0000-0000-000000000007', 'like'),
  -- Bibimbap: liked by Alice, Emma; bookmarked by Emma
  ('a0000001-0000-0000-0000-000000000001', 'b0000008-0000-0000-0000-000000000008', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000008-0000-0000-0000-000000000008', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000008-0000-0000-0000-000000000008', 'bookmark'),
  -- Focaccia: liked by Alice, Carlos, Diana
  ('a0000001-0000-0000-0000-000000000001', 'b0000009-0000-0000-0000-000000000009', 'like'),
  ('a0000003-0000-0000-0000-000000000003', 'b0000009-0000-0000-0000-000000000009', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000009-0000-0000-0000-000000000009', 'like'),
  -- Pão de Queijo: liked by Alice, Bob, Diana, Emma
  ('a0000001-0000-0000-0000-000000000001', 'b0000010-0000-0000-0000-000000000010', 'like'),
  ('a0000002-0000-0000-0000-000000000002', 'b0000010-0000-0000-0000-000000000010', 'like'),
  ('a0000004-0000-0000-0000-000000000004', 'b0000010-0000-0000-0000-000000000010', 'like'),
  ('a0000005-0000-0000-0000-000000000005', 'b0000010-0000-0000-0000-000000000010', 'like')
...
INSERT INTO public.ratings (user_id, recipe_id, score) VALUES
  -- Mapo Tofu: avg ~4.3
  ('a0000002-0000-0000-0000-000000000002', 'b0000001-0000-0000-0000-000000000001', 5),
  ('a0000004-0000-0000-0000-000000000004', 'b0000001-0000-0000-0000-000000000001', 4),
  ('a0000005-0000-0000-0000-000000000005', 'b0000001-0000-0000-0000-000000000001', 4),
  -- Brisket Tacos: avg 4.75
  ('a0000001-0000-0000-0000-000000000001', 'b0000002-0000-0000-0000-000000000002', 5),
  ('a0000003-0000-0000-0000-000000000003', 'b0000002-0000-0000-0000-000000000002', 5),
  ('a0000004-0000-0000-0000-000000000004', 'b0000002-0000-0000-0000-000000000002', 4),
  ('a0000005-0000-0000-0000-000000000005', 'b0000002-0000-0000-0000-000000000002', 5),
  -- Shakshuka: avg 4.0
  ('a0000001-0000-0000-0000-000000000001', 'b0000003-0000-0000-0000-000000000003', 4),
  ('a0000002-0000-0000-0000-000000000002', 'b0000003-0000-0000-0000-000000000003', 4),
  -- Kimchi Jjigae: avg 4.7
  ('a0000001-0000-0000-0000-000000000001', 'b0000004-0000-0000-0000-000000000004', 5),
  ('a0000003-0000-0000-0000-000000000003', 'b0000004-0000-0000-0000-000000000004', 5),
  ('a0000005-0000-0000-0000-000000000005', 'b0000004-0000-0000-0000-000000000004', 4),
  -- Mushroom Risotto: avg 4.3
  ('a0000002-0000-0000-0000-000000000002', 'b0000005-0000-0000-0000-000000000005', 5),
  ('a0000003-0000-0000-0000-000000000003', 'b0000005-0000-0000-0000-000000000005', 4),
  ('a0000004-0000-0000-0000-000000000004', 'b0000005-0000-0000-0000-000000000005', 4),
  -- Dumplings: avg 5.0
  ('a0000002-0000-0000-0000-000000000002', 'b0000006-0000-0000-0000-000000000006', 5),
  ('a0000003-0000-0000-0000-000000000003', 'b0000006-0000-0000-0000-000000000006', 5),
  ('a0000005-0000-0000-0000-000000000005', 'b0000006-0000-0000-0000-000000000006', 5),
  -- Guacamole: avg 4.5
  ('a0000001-0000-0000-0000-000000000001', 'b0000007-0000-0000-0000-000000000007', 5),
  ('a0000003-0000-0000-0000-000000000003', 'b0000007-0000-0000-0000-000000000007', 4),
  ('a0000004-0000-0000-0000-000000000004', 'b0000007-0000-0000-0000-000000000007', 5),
  ('a0000005-0000-0000-0000-000000000005', 'b0000007-0000-0000-0000-000000000007', 4),
  -- Bibimbap: avg 5.0
  ('a0000001-0000-0000-0000-000000000001', 'b0000008-0000-0000-0000-000000000008', 5),
  ('a0000005-0000-0000-0000-000000000005', 'b0000008-0000-0000-0000-000000000008', 5),
  -- Pão de Queijo: avg 4.5
  ('a0000001-0000-0000-0000-000000000001', 'b0000010-0000-0000-0000-000000000010', 5),
  ('a0000002-0000-0000-0000-000000000002', 'b0000010-0000-0000-0000-000000000010', 4),
  ('a0000004-0000-0000-0000-000000000004', 'b0000010-0000-0000-0000-000000000010', 5),
  ('a0000005-0000-0000-0000-000000000005', 'b0000010-0000-0000-0000-000000000010', 4)
...
INSERT INTO public.group_members (group_id, user_id, role) VALUES
  ('f0000001-0000-0000-0000-000000000001', 'a0000001-0000-0000-0000-000000000001', 'admin'),
  ('f0000001-0000-0000-0000-000000000001', 'a0000002-0000-0000-0000-000000000002', 'member'),
  ('f0000001-0000-0000-0000-000000000001', 'a0000004-0000-0000-0000-000000000004', 'member')
ON CONFLICT DO NOTHING;

INSERT INTO public.group_recipes (group_id, recipe_id, added_by) VALUES
  ('f0000001-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000001', 'a0000001-0000-0000-0000-000000000001'),
  ('f0000001-0000-0000-0000-000000000001', 'b0000003-0000-0000-0000-000000000003', 'a0000001-0000-0000-0000-000000000001'),
  ('f0000001-0000-0000-0000-000000000001', 'b0000007-0000-0000-0000-000000000007', 'a0000002-0000-0000-0000-000000000002')
